angular.module('guaraniApp').controller('treeGridControllerCompareGeral', function ($scope, $http, $timeout, ParamService, $routeParams) {
	    ...
	    $scope.updateTables = function(){
    		ParamService.versaoorigem = $scope.layout;
    		console.log(ParamService.versaoorigem);
    		console.log($routeParams.gua_pro_id); 
    	}; 	 
     	
	     
    	$scope.setVersaoCompare = function() {
    		$http.get('rest/tabelas/'+ ParamService.versaoorigem +'/' + $routeParams.gua_pro_id)
