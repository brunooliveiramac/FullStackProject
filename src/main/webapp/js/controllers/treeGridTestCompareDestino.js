angular.module('guaraniApp').controller('treeGridControllerCompareDestino', function ($scope, $http, $timeout, ParamService, $routeParams) {
		...
		$scope.updateTables = function(){
    		ParamService.versaocompare = $scope.layout;
    		console.log(ParamService.versaocompare);
    		console.log($routeParams.id);
    	}; 	 
     	

    	$scope.setVersaoCompare = function() {
	      	  $http.get('rest/tabelas/tabela/'+ParamService.versaocompare+'/'+ $routeParams.id)
